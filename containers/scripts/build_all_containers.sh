...
Examples:
  ...
  ./containers/scripts/build_all_containers.sh --docker-namespace covehub --tag v1
  ./containers/scripts/build_all_containers.sh --docker-namespace covehub --tag v1 --push
EOF
}
